...
volatile uint8_t leds_enabled = 1;  // 1 = LEDs flash, 0 = LEDs off
...
int main(void)
{
  ...
  printf("\r\n=================================\r\n");
  printf("All LEDs Flash Control (Polling)\r\n");
  printf("Press button to enable/disable\r\n");
  printf("=================================\r\n");
  ...
  printf("System ready - LEDs should be flashing\r\n\r\n");
